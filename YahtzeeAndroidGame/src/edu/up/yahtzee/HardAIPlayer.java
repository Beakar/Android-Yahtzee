...
public class HardAIPlayer extends GameComputerPlayer {
	...
	// HOLD STAGE 2
	// Keeps to the standard of always trying to get Yahtzee
	if(myGame.getAIHolds() == 0){
	...
	// ROLL STAGE 3
	// The AI will have rolled 3 times at this point so
	// We cannot roll the dice anymore
	if(myGame.getAIHolds() == 2){
	    RollAction rollThree = new RollAction(game.whoseTurn());
	    return rollThree;   
	}
	// END ROLL STAGE 3
	// WE NOW CANNOT ROLL THE DICE ANYMORE
